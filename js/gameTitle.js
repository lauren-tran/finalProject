function gameTitle(game) {
    return {
        ...
        create: function () {
            ...
            */  
             var playButton=
                game.add.button(120,450,'play2',function (){
                    game.state.start('start')
                })
            
            var store = this.game.add.button(280, 450, 'store', this.store, null, this);
            
            var mission = this.game.add.button(450, 450,'mission')
